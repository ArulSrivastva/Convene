    ...
    <div className={`flex h-screen bg-background overflow-hidden relative ${theme}`}>
      ...
      {isSidebarOpen && (
        <>
          ...
          />
          <aside className="w-72 bg-sidebar border-r border-border-color flex flex-col justify-between fixed inset-y-0 left-0 md:relative z-30 animate-in slide-in-from-left duration-200 shadow-2xl md:shadow-none">
